...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        campus_btn = (Button) findViewById(R.id.placement_Btn);
...
/*
        ...
        mEnotesBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(MainActivity.this, enotes.class));
            }
        });
        ...
        campus_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(MainActivity.this,campus_placement.class));
            }
        });
    }
    @Override
